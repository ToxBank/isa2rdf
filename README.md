...
### [isa2rdf-1.0.1-SNAPSHOT.jar] (http://ambit.uni-plovdiv.bg:8083/nexus/index.html#nexus-search;gav~~isa2rdf-cli~1.0.1-SNAPSHOT~~)
>java -jar isa2rdf-1.0.1-SNAPSHOT.jar
